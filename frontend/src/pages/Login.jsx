...
//         <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-xl w-full max-w-md relative overflow-hidden border border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-out hover:scale-105 lg:max-w-lg">
...
//             <button
//               type="submit"
//               className={`w-full py-3 rounded-lg bg-gradient-to-r from-indigo-500 to-blue-600 text-white font-bold shadow-lg hover:from-indigo-600 hover:to-blue-700 transition duration-200 transform hover:scale-105 ${
