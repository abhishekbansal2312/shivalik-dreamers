      ...
      <div className={`w-full sm:w-2/3 md:w-1/2 lg:w-1/3 max-w-lg mx-auto mt-10 p-8 shadow-lg rounded-lg ${
        ...
        {user && !editMode && (
          <div className="space-y-6">
            ...
            <button onClick={handleEdit} className="w-full py-2 mt-4 bg-blue-600 text-white rounded-full shadow-md transition duration-300">
              Edit Profile
            </button>
            <button onClick={handleDelete} className="w-full py-2 mt-4 bg-red-600 text-white rounded-full shadow-md transition duration-300">
              Delete Profile
            </button>
          </div>
        )}
        ...
        {editMode && (
          <div className="space-y-6">
            ...
            <button onClick={handleUpdate} className="w-full py-2 bg-green-600 text-white rounded-full shadow-md transition duration-300">
              Save Changes
            </button>
            <button onClick={() => setEditMode(false)} className="w-full py-2 mt-4 bg-gray-600 text-white rounded-full shadow-md transition duration-300">
              Cancel
            </button>
          </div>
        )}
